...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden border-zinc-600 overflow-x-hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block overflow-x-hidden"
        data-state={state}
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-zinc-600 group-data-[variant=floating]:shadow overflow-x-hidden"
          >
            {children}
          </div>
        </div>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {useSidebar().state === "collapsed" ? <ArrowLeft /> : <ArrowRight />}
